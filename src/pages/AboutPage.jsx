  ...
  return (
    <div className="space-y-10">
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-[30px] border border-slate-200 bg-slate-50 p-8">
          ...
          <ul className="mt-3 space-y-3 text-sm text-slate-600">
            <li>• {t('aboutPage.verifiedInfo')}</li>
            <li>• {t('aboutPage.easyFilters')}</li>
            <li>• {t('aboutPage.friendlySupport')}</li>
          </ul>
        </div>
      </section>
      ...
      <section className="rounded-[30px] border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 text-slate-600">{t('aboutPage.readySubtitle')}</p>
