...
const batchOneTranslations = {
  ...
  gu: {
    buy: {
      pageTitle: 'વિશ્વાસ સાથે જમીન શોધો.', subtitle: 'ચકાસેલી કૃષિ અને બિન-કૃષિ જમીન લિસ્ટિંગ જુઓ.',
...
const batchTwoTranslations = {
  en: {
    ...
    home: {
      ...
      govDastavejDownload: 'Dastavej Download',
      govPropertyCard: 'Property Card',
      gov712Entry: '7/12, Entry',
      govDownloadPropertyCard: 'Download Property Card',
      gov712Download: '7/12 Download',
      govJantriRate: 'Jantri Rate',
      govIndex2: 'Index - 2',
      govRevenueCaseStatus: 'Revenue Case Status',
      govEDharaForms: 'E-Dhara Forms',
      govIORAServices: 'IORA Services',
    },
    buyerRequirements: {
      pageTitle: 'Buyer Requirements',
      subtitle: 'Connect with buyers looking for agricultural and non-agricultural land across Gujarat.',
      eyebrow: 'BUYER MARKETPLACE',
      searchPlaceholder: 'Search by district, taluka, village, property type or requirements...',
      foundCount: 'buyer requirements found',
      noRequirementsFound: 'No buyer requirements found matching your criteria.',
      budgetLabel: 'Budget / Expected Price',
      areaLabel: 'Required Area',
      purposeLabel: 'Purpose',
  ...
  gu: {
    ...
    home: {
      ...
      govDastavejDownload: 'દસ્તાવેજ ડાઉનલોડ',
      govPropertyCard: 'પ્રોપર્ટી કાર્ડ',
      gov712Entry: '૭/૧૨, નોંધ',
      govDownloadPropertyCard: 'પ્રોપર્ટી કાર્ડ ડાઉનલોડ',
      gov712Download: '૭/૧૨ ડાઉનલોડ',
      govJantriRate: 'જંત્રી દર',
      govIndex2: 'ઇન્ડેક્સ - ૨',
      govRevenueCaseStatus: 'મહેસૂલી કેસની સ્થિતિ',
      govEDharaForms: 'ઈ-ધારા ફોર્મ્સ',
      govIORAServices: 'IORA સેવાઓ',
    },
    buyerRequirements: {
      pageTitle: 'બાયર રિક્વાયરમેન્ટ્સ',
      subtitle: 'ગુજરાતભરમાં કૃષિ અને બિન-કૃષિ જમીન શોધતા ખરીદદારો સાથે સંપર્ક કરો.',
      eyebrow: 'ખરીદદાર માર્કેટપ્લેસ',
      searchPlaceholder: 'જિલ્લો, તાલુકો, ગામ, જમીનનો પ્રકાર અથવા જરૂરિયાત દ્વારા શોધો...',
      foundCount: 'ખરીદદારની જરૂરિયાતો મળી',
      noRequirementsFound: 'તમારી પસંદગી મુજબ કોઈ ખરીદદારની જરૂરિયાત મળી નથી.',
      budgetLabel: 'બજેટ / અપેક્ષિત કિંમત',
      areaLabel: 'જરૂરી વિસ્તાર',
      purposeLabel: 'હેતુ',
      locationLabel: 'પસંદગીનું સ્થાન',
    },
  },
};
